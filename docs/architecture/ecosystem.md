...
Существующие
[`overview`](./overview.md), [`plugin-model`](./plugin-model.md) и
[`host-api-model`](./host-api-model.md) описывают компоненты при
...
[`recipes/write-link-plugin.md`](../recipes/write-link-plugin.md),
[`write-handler-plugin.md`](../recipes/write-handler-plugin.md),
[`write-security-plugin.md`](../recipes/write-security-plugin.md).

### Контракты, которые плагин должен соблюдать

- [`link.md`](../contracts/link.md) — link плагин: vtable shape,
  shutdown semantics, single-writer, trust class declaration
- [`handler-registration.md`](../contracts/handler-registration.md) —
  handler плагин: msg_id range, propagation values, lifetime
- [`security-trust.md`](../contracts/security-trust.md) — security
  plugin: handshake driver, single-active-per-trust-class,
  attestation hooks
- [`plugin-lifetime.md`](../contracts/plugin-lifetime.md) — все
  плагины: 5 entry symbols, init/register/run/unregister/shutdown
- [`plugin-manifest.md`](../contracts/plugin-manifest.md) — manifest
...
Подробный walkthrough: см.
[`recipes/test-plugin.md`](../recipes/test-plugin.md) +
[`impl/cpp/cmake-integration.md`](../impl/cpp/cmake-integration.md).
...
| Тэг | Что означает |
|---|---|
| `kernel/v1.0.0-rc1` | ABI freeze. После этого тэга `host_api_t`, `gn_link_vtable_t`, `gn_handler_vtable_t`, `gn_security_provider_vtable_t`, `gn_message_t` shape — стабильны. Любая правка идёт через `_reserved` слот + `api_size` gating per [`abi-evolution.md`](../contracts/abi-evolution.md) |
...
- [`overview`](./overview.md) — kernel = ABI table + 4 vtable kinds + executor
- [`plugin-model`](./plugin-model.md) — четыре роли плагина
- [`host-api-model`](./host-api-model.md) — KIND-tagged minimalism
- [`extension-model`](./extension-model.md) — plugin↔plugin coordination
- [`recipes/write-handler-plugin.md`](../recipes/write-handler-plugin.md) —
  пошаговое создание handler плагина
- [`recipes/write-link-plugin.md`](../recipes/write-link-plugin.md) —
  link plugin walkthrough
- [`impl/cpp/cmake-integration.md`](../impl/cpp/cmake-integration.md) —
  как app или binding линкуются с kernel/SDK
- [`contracts/plugin-lifetime.md`](../contracts/plugin-lifetime.md) —
  lifecycle invariants
- [`contracts/abi-evolution.md`](../contracts/abi-evolution.md) — ABI
