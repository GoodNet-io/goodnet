...
тот же объект (см. [registry.md](../contracts/registry.md) §1).
...
[conn-events.md](../contracts/conn-events.md) §2a) запись и связанные
...
2. Плагин подписан на канал `GN_SUBSCRIBE_CONN_STATE` через
   ...
   [host-api.md](../contracts/host-api.md) §2). Подписка существовала
   ...
   числом, см. [conn-events.md](../contracts/conn-events.md) §5).
3. На событие `GN_CONN_EVENT_CONNECTED` для `new_conn` плагин ждёт
   ...
   [security-trust.md](../contracts/security-trust.md) §3.
...
[uri.md](../contracts/uri.md) §2), и находит link-плагин по `scheme`
...
peer-pin map'е, см. [registry.md](../contracts/registry.md) §8a).
...
[conn-events.md](../contracts/conn-events.md) §2a). Тем не менее
...
[registry.md](../contracts/registry.md) §6).
...
- Контракт событий: [conn-events.md](../contracts/conn-events.md)
- Контракт регистра: [registry.md](../contracts/registry.md)
- Контракт URI: [uri.md](../contracts/uri.md)
- Trust-class и upgrade: [security-trust.md](../contracts/security-trust.md)
- host_api: [host-api.md](../contracts/host-api.md)
- Конкретный пример того же шаблона: [relay-direct](./relay-direct.md)
- Как extension выставляет себя в shared namespace: [extension-model](./extension-model.md)
- Жизнь security-сессии в этом цикле: [security-flow](./security-flow.md)
