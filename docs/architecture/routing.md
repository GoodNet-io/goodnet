...
[host-api.md §2](../contracts/host-api.md). Транспорт никогда не парсит
...
[backpressure.md §9](../contracts/backpressure.md), так что злонамеренный
...
[protocol-layer.md §3](../contracts/protocol-layer.md). Каждый
...
[protocol-layer.md §6](../contracts/protocol-layer.md).
...
URI-парсера живёт в [uri.md](../contracts/uri.md); парсер чистый, без
DNS, без процентного декодирования.

Адрес выводится из двух компонент по протоколу
[identity.md §3](../contracts/identity.md): user-keypair (долгоживущий,
...
[handler-registration.md §2](../contracts/handler-registration.md):
...
[handler-registration.md §5](../contracts/handler-registration.md).
...
`CONTINUE` per [handler-registration.md §3a](../contracts/handler-registration.md).
...
[registry.md §3](../contracts/registry.md) выполняется так:
...
[registry.md §8](../contracts/registry.md).
...
[backpressure.md §3](../contracts/backpressure.md).
...
Per [protocol-layer.md §5](../contracts/protocol-layer.md). На relay-
...
[host-api.md §8](../contracts/host-api.md).
...
[uri.md](../contracts/uri.md) перечисляет recognised forms,
...
[backpressure.md](../contracts/backpressure.md) определяет три
