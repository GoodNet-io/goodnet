...
_17 config key(s) read by core / plugins, grouped by family._

### `ice` keys

| Key | Type | Reader |
|---|---|---|
| `ice.aggressive_nomination` | `int64` | [`plugins/links/ice/link_ice.cpp#L177`](../../plugins/links/ice/link_ice.cpp#L177) |
| `ice.check_interval_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L156`](../../plugins/links/ice/link_ice.cpp#L156) |
| `ice.consent_max_failures` | `int64` | [`plugins/links/ice/link_ice.cpp#L152`](../../plugins/links/ice/link_ice.cpp#L152) |
| `ice.keepalive_interval_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L148`](../../plugins/links/ice/link_ice.cpp#L148) |
| `ice.path_mtu` | `int64` | [`plugins/links/ice/link_ice.cpp#L168`](../../plugins/links/ice/link_ice.cpp#L168) |
| `ice.session_timeout_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L144`](../../plugins/links/ice/link_ice.cpp#L144) |
| `ice.turn_password` | `string` | [`plugins/links/ice/link_ice.cpp#L133`](../../plugins/links/ice/link_ice.cpp#L133) |
| `ice.turn_servers` | `string` | [`plugins/links/ice/link_ice.cpp#L95`](../../plugins/links/ice/link_ice.cpp#L95) |
| `ice.turn_tcp` | `int64` | [`plugins/links/ice/link_ice.cpp#L184`](../../plugins/links/ice/link_ice.cpp#L184) |
| `ice.turn_tls` | `int64` | [`plugins/links/ice/link_ice.cpp#L192`](../../plugins/links/ice/link_ice.cpp#L192) |
| `ice.turn_username` | `string` | [`plugins/links/ice/link_ice.cpp#L120`](../../plugins/links/ice/link_ice.cpp#L120) |

### `links` keys

| Key | Type | Reader |
|---|---|---|
| `links.tls.cert_path` | `string` | [`plugins/links/tls/tls.cpp#L493`](../../plugins/links/tls/tls.cpp#L493) |
| `links.tls.key_path` | `string` | [`plugins/links/tls/tls.cpp#L502`](../../plugins/links/tls/tls.cpp#L502) |
| `links.tls.verify_peer` | `bool` | [`plugins/links/tls/tls.cpp#L386`](../../plugins/links/tls/tls.cpp#L386) |
