...
_40 config key(s) read by core / plugins, grouped by family._
...
| `ice.auto_restart_backoff_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L447`](../../plugins/links/ice/link_ice.cpp#L447) |
| `ice.auto_restart_max_attempts` | `int64` | [`plugins/links/ice/link_ice.cpp#L443`](../../plugins/links/ice/link_ice.cpp#L443) |
| `ice.auto_restart_on_consent_loss` | `int64` | [`plugins/links/ice/link_ice.cpp#L439`](../../plugins/links/ice/link_ice.cpp#L439) |
...
| `ice.pmtu_active_probing` | `int64` | [`plugins/links/ice/link_ice.cpp#L455`](../../plugins/links/ice/link_ice.cpp#L455) |
| `ice.pmtu_probe_concurrency` | `int64` | [`plugins/links/ice/link_ice.cpp#L462`](../../plugins/links/ice/link_ice.cpp#L462) |
| `ice.pmtu_probe_timeout_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L458`](../../plugins/links/ice/link_ice.cpp#L458) |
...
| `ice.tcp_candidates_enabled` | `int64` | [`plugins/links/ice/link_ice.cpp#L425`](../../plugins/links/ice/link_ice.cpp#L425) |
| `ice.tcp_so_timeout_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L431`](../../plugins/links/ice/link_ice.cpp#L431) |
...
| Key | Type | Reader |
|---|---|---|
| `udp.new_conn_burst` | `int64` | [`plugins/links/udp/udp.cpp#L75`](../../plugins/links/udp/udp.cpp#L75) |
| `udp.new_conn_lru_cap` | `int64` | [`plugins/links/udp/udp.cpp#L79`](../../plugins/links/udp/udp.cpp#L79) |
| `udp.new_conn_rate` | `int64` | [`plugins/links/udp/udp.cpp#L71`](../../plugins/links/udp/udp.cpp#L71) |
<!-- /livedoc:config_keys_table -->
