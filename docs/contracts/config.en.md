...
_53 config key(s) read by core / plugins, grouped by family._

### `ice` keys

| Key | Type | Reader |
|---|---|---|
| `ice.aggressive_nomination` | `int64` | [`plugins/links/ice/link_ice.cpp#L334`](../../plugins/links/ice/link_ice.cpp#L334) |
| `ice.auto_restart_backoff_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L502`](../../plugins/links/ice/link_ice.cpp#L502) |
| `ice.auto_restart_max_attempts` | `int64` | [`plugins/links/ice/link_ice.cpp#L498`](../../plugins/links/ice/link_ice.cpp#L498) |
| `ice.auto_restart_on_consent_loss` | `int64` | [`plugins/links/ice/link_ice.cpp#L494`](../../plugins/links/ice/link_ice.cpp#L494) |
| `ice.check_interval_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L302`](../../plugins/links/ice/link_ice.cpp#L302) |
| `ice.consent_max_failures` | `int64` | [`plugins/links/ice/link_ice.cpp#L289`](../../plugins/links/ice/link_ice.cpp#L289) |
| `ice.consent_max_recovery` | `int64` | [`plugins/links/ice/link_ice.cpp#L298`](../../plugins/links/ice/link_ice.cpp#L298) |
| `ice.keepalive_interval_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L285`](../../plugins/links/ice/link_ice.cpp#L285) |
| `ice.lite_mode` | `int64` | [`plugins/links/ice/link_ice.cpp#L341`](../../plugins/links/ice/link_ice.cpp#L341) |
| `ice.max_check_retries` | `int64` | [`plugins/links/ice/link_ice.cpp#L306`](../../plugins/links/ice/link_ice.cpp#L306) |
| `ice.mdns_obfuscate_host_candidates` | `int64` | [`plugins/links/ice/link_ice.cpp#L427`](../../plugins/links/ice/link_ice.cpp#L427) |
| `ice.mdns_resolve_timeout_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L431`](../../plugins/links/ice/link_ice.cpp#L431) |
| `ice.nomination_wait_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L310`](../../plugins/links/ice/link_ice.cpp#L310) |
| `ice.path_mtu` | `int64` | [`plugins/links/ice/link_ice.cpp#L322`](../../plugins/links/ice/link_ice.cpp#L322) |
| `ice.pmtu_active_probing` | `int64` | [`plugins/links/ice/link_ice.cpp#L510`](../../plugins/links/ice/link_ice.cpp#L510) |
| `ice.pmtu_probe_concurrency` | `int64` | [`plugins/links/ice/link_ice.cpp#L517`](../../plugins/links/ice/link_ice.cpp#L517) |
| `ice.pmtu_probe_timeout_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L513`](../../plugins/links/ice/link_ice.cpp#L513) |
| `ice.reactive_interface_change` | `int64` | [`plugins/links/ice/link_ice.cpp#L344`](../../plugins/links/ice/link_ice.cpp#L344) |
| `ice.session_timeout_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L281`](../../plugins/links/ice/link_ice.cpp#L281) |
| `ice.symmetric_port_prediction_attempts` | `int64` | [`plugins/links/ice/link_ice.cpp#L351`](../../plugins/links/ice/link_ice.cpp#L351) |
| `ice.symmetric_port_prediction_enabled` | `int64` | [`plugins/links/ice/link_ice.cpp#L347`](../../plugins/links/ice/link_ice.cpp#L347) |
| `ice.tcp_candidates_enabled` | `int64` | [`plugins/links/ice/link_ice.cpp#L480`](../../plugins/links/ice/link_ice.cpp#L480) |
| `ice.tcp_so_timeout_ms` | `int64` | [`plugins/links/ice/link_ice.cpp#L486`](../../plugins/links/ice/link_ice.cpp#L486) |
| `ice.turn_allocate_timeout_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L404`](../../plugins/links/ice/link_ice.cpp#L404) |
| `ice.turn_backup_interval_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L411`](../../plugins/links/ice/link_ice.cpp#L411) |
| `ice.turn_failover_min_interval_s` | `int64` | [`plugins/links/ice/link_ice.cpp#L417`](../../plugins/links/ice/link_ice.cpp#L417) |
| `ice.turn_password` | `string` | [`plugins/links/ice/link_ice.cpp#L269`](../../plugins/links/ice/link_ice.cpp#L269) |
| `ice.turn_requested_transport` | `string` | [`plugins/links/ice/link_ice.cpp#L453`](../../plugins/links/ice/link_ice.cpp#L453) |
| `ice.turn_servers` | `string` | [`plugins/links/ice/link_ice.cpp#L223`](../../plugins/links/ice/link_ice.cpp#L223) |
| `ice.turn_tcp` | `bool` | [`plugins/links/ice/link_ice.cpp#L396`](../../plugins/links/ice/link_ice.cpp#L396) |
| `ice.turn_tls` | `int64` | [`plugins/links/ice/link_ice.cpp#L440`](../../plugins/links/ice/link_ice.cpp#L440) |
| `ice.turn_username` | `string` | [`plugins/links/ice/link_ice.cpp#L255`](../../plugins/links/ice/link_ice.cpp#L255) |
...
| Key | Type | Reader |
|---|---|---|
| `raw_inject.default_msg_id` | `int64` | [`plugins/links/raw_inject/raw_inject.cpp#L108`](../../plugins/links/raw_inject/raw_inject.cpp#L108) |
| `raw_inject.encode_msg_id` | `string` | [`plugins/links/raw_inject/raw_inject.cpp#L120`](../../plugins/links/raw_inject/raw_inject.cpp#L120) |
| `raw_inject.listen` | `string` | [`plugins/links/raw_inject/raw_inject.cpp#L101`](../../plugins/links/raw_inject/raw_inject.cpp#L101) |
| `raw_inject.max_payload` | `int64` | [`plugins/links/raw_inject/raw_inject.cpp#L116`](../../plugins/links/raw_inject/raw_inject.cpp#L116) |
| `raw_inject.rate_limit_per_sec` | `int64` | [`plugins/links/raw_inject/raw_inject.cpp#L112`](../../plugins/links/raw_inject/raw_inject.cpp#L112) |
| `raw_inject.target_ns` | `string` | [`plugins/links/raw_inject/raw_inject.cpp#L126`](../../plugins/links/raw_inject/raw_inject.cpp#L126) |
| `raw_inject.zstd_compress` | `int64` | [`plugins/links/raw_inject/raw_inject.cpp#L132`](../../plugins/links/raw_inject/raw_inject.cpp#L132) |
| `raw_inject.zstd_level` | `int64` | [`plugins/links/raw_inject/raw_inject.cpp#L134`](../../plugins/links/raw_inject/raw_inject.cpp#L134) |
| `raw_inject.zstd_max_decompress` | `int64` | [`plugins/links/raw_inject/raw_inject.cpp#L137`](../../plugins/links/raw_inject/raw_inject.cpp#L137) |

### `udp` keys

| Key | Type | Reader |
|---|---|---|
| `udp.new_conn_burst` | `int64` | [`plugins/links/udp/udp.cpp#L82`](../../plugins/links/udp/udp.cpp#L82) |
| `udp.new_conn_lru_cap` | `int64` | [`plugins/links/udp/udp.cpp#L86`](../../plugins/links/udp/udp.cpp#L86) |
| `udp.new_conn_rate` | `int64` | [`plugins/links/udp/udp.cpp#L78`](../../plugins/links/udp/udp.cpp#L78) |

### `ws_inject` keys

| Key | Type | Reader |
|---|---|---|
| `ws_inject.default_msg_id` | `int64` | [`plugins/links/ws_inject/ws_inject.cpp#L118`](../../plugins/links/ws_inject/ws_inject.cpp#L118) |
| `ws_inject.encode_msg_id` | `string` | [`plugins/links/ws_inject/ws_inject.cpp#L130`](../../plugins/links/ws_inject/ws_inject.cpp#L130) |
| `ws_inject.listen` | `string` | [`plugins/links/ws_inject/ws_inject.cpp#L112`](../../plugins/links/ws_inject/ws_inject.cpp#L112) |
| `ws_inject.max_payload` | `int64` | [`plugins/links/ws_inject/ws_inject.cpp#L126`](../../plugins/links/ws_inject/ws_inject.cpp#L126) |
| `ws_inject.rate_limit_per_sec` | `int64` | [`plugins/links/ws_inject/ws_inject.cpp#L122`](../../plugins/links/ws_inject/ws_inject.cpp#L122) |
| `ws_inject.target_ns` | `string` | [`plugins/links/ws_inject/ws_inject.cpp#L135`](../../plugins/links/ws_inject/ws_inject.cpp#L135) |
<!-- /livedoc:config_keys_table -->
