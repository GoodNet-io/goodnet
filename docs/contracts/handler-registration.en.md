...
<!-- livedoc:handler_vtable_slots -->
<!-- generated by tools/livedoc.py — do not edit by hand; rerun `make livedoc` to refresh -->

Handler vtable — **6 slots** + `4` reserved ([`sdk/handler.h`](../../sdk/handler.h)).

| Slot | Signature |
|---|---|
| [protocol_id](../../sdk/handler.h#L68) | `const char * (*)(void *)` |
| [supported_msg_ids](../../sdk/handler.h#L80) | `void (*)(void *, const uint32_t **, size_t *)` |
| [handle_message](../../sdk/handler.h#L95) | `gn_propagation_t (*)(void *, const gn_message_t *)` |
| [on_result](../../sdk/handler.h#L109) | `void (*)(void *, const gn_message_t *, gn_propagation_t)` |
| [on_init](../../sdk/handler.h#L122) | `void (*)(void *)` |
| [on_shutdown](../../sdk/handler.h#L123) | `void (*)(void *)` |
<!-- /livedoc:handler_vtable_slots -->
