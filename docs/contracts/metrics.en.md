...
_7 counter name(s) emitted across the tree._
...
| `gn.multipath-bond.degraded_peers` | gn | [`plugins/strategies/multipath_bond/multipath_bond.cpp`](../../plugins/strategies/multipath_bond/multipath_bond.cpp) |
| `raw_inject.drop.zstd_error` | raw_inject | [`plugins/links/raw_inject/raw_inject.cpp`](../../plugins/links/raw_inject/raw_inject.cpp) |
| `raw_inject.inject.error` | raw_inject | [`plugins/links/raw_inject/raw_inject.cpp`](../../plugins/links/raw_inject/raw_inject.cpp) |
| `ws_inject.drop.short_stream` | ws_inject | [`plugins/links/ws_inject/ws_inject.cpp`](../../plugins/links/ws_inject/ws_inject.cpp) |
| `ws_inject.drop.too_large` | ws_inject | [`plugins/links/ws_inject/ws_inject.cpp`](../../plugins/links/ws_inject/ws_inject.cpp) |
| `ws_inject.inject.error` | ws_inject | [`plugins/links/ws_inject/ws_inject.cpp`](../../plugins/links/ws_inject/ws_inject.cpp) |
<!-- /livedoc:metrics_catalog_table -->
...
- Logging surface: `host-api.en.md` §11 (`log` slot — separate from
