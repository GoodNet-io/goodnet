...
Контракт [clock.md](../../contracts/clock.md) требует, чтобы каждый
...
См. [clock contract](../../contracts/clock.md) §3 — список
...
- [clock contract](../../contracts/clock.md) — авторитетный инвариант.
- [timer contract](../../contracts/timer.md) — `set_timer` /
  `cancel_timer` semantics, weak-observer гарантия для callback'а.
- [overview](./overview.md) — общий контекст C++ обёрток.
- [error-handling](./error-handling.md) — что вернуть, если
