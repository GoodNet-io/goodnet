...
[plugin-lifetime](../../contracts/plugin-lifetime.en.md) §weak-anchor).
...
evolution`, см. [abi-evolution](../../contracts/abi-evolution.en.md).
...
[plugin-lifetime](../../contracts/plugin-lifetime.en.md) §8): после
...
- [host-api contract](../../contracts/host-api.en.md) — каждое entry с
  borrowed/owned аннотацией.
- [plugin-lifetime contract](../../contracts/plugin-lifetime.en.md) —
  weak-anchor, drain, shutdown ordering.
- [overview](overview.ru.md) — общая структура C++ обёрток.
- [error-handling](error-handling.ru.md) — `GN_ERR_OUT_OF_MEMORY`,
  cleanup-guards.
