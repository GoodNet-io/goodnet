...
[gnet-frames](./gnet-frames.md)). Pre-fragmentation на kernel уровне
...
Cross-link: [security-trust.md](../contracts/security-trust.md) §6
...
- [attestation-bytes](./attestation-bytes.md) — payload, обменивающийся
...
- [security-flow](../architecture/security-flow.md) — где SecuritySession
...
- [handshake.md](../../plugins/security/noise/docs/handshake.md) —
  ...
  invariants)
- [gnet-frames](./gnet-frames.md) — plaintext-layer, сидящий внутри
  ciphertext'а
