...
- [gnet-frames](gnet-frames.ru.md) — 14-байтный fixed header GNET, три
  encoding-режима, conditional PK поля, парсер state machine.
- [noise-handshake](noise-handshake.ru.md) — 3-message XX exchange,
  layout каждого сообщения, transport-phase framing, rekey threshold.
- [attestation-bytes](attestation-bytes.ru.md) — 232-байтный signed
...
- [security-flow](../architecture/security-flow.ru.md) — где живут
