...
`<libfile>.json` (см. [plugin-manifest.md](../contracts/plugin-manifest.md) §8).
...
- [plugin-lifetime.md](../contracts/plugin-lifetime.md) — фазы 3..10,
  два-фазная активация, weak-observer pattern.
- [plugin-manifest.md](../contracts/plugin-manifest.md) — operator
  manifest, per-package JSON, integrity-check ordering.
- [host-api.md](../contracts/host-api.md) — `register_vtable`,
