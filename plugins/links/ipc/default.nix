# Standalone Nix derivation for the goodnet-link-ipc plugin.
...
# nlohmann_json). Build artefacts: `lib<goodnet_link_ipc>.so`
...
stdenv.mkDerivation {
  ...
  meta = {
    description = "GoodNet plugin: goodnet-link-ipc";
