# Standalone dev / test / build flake for the goodnet-link-ipc
...
#
# goodnet-standalone-plugin: ipc
{
  description = "GoodNet link plugin: ipc — standalone plugin flake.";
    ...
    in
    {
      ...
      devShells = forAllSystems (system: pkgs: {
        default = helpers.mkPluginDevShell pkgs {
          ...
          welcomeText = ''
  goodnet-link-ipc  —  standalone plugin dev shell
    ...
    nix run .#debug      — Debug build + gdb on test_ipc
'';
        };
      });
