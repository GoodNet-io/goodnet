...
_Static_assert(offsetof(gn_message_t, sender_pk) == 4,
               "gn_message_t::sender_pk offset pinned at 4");
_Static_assert(offsetof(gn_message_t, receiver_pk) == 36,
               "gn_message_t::receiver_pk offset pinned at 36");
_Static_assert(offsetof(gn_message_t, msg_id) == 68,
               "gn_message_t::msg_id offset pinned at 68");
...
_Static_assert(sizeof(gn_endpoint_t) == 408,
               "gn_endpoint_t size pinned at 408");
_Static_assert(offsetof(gn_endpoint_t, api_size) == 0,
               "gn_endpoint_t::api_size offset pinned at 0");
_Static_assert(offsetof(gn_endpoint_t, conn_id) == 8,
               "gn_endpoint_t::conn_id offset pinned at 8");
_Static_assert(offsetof(gn_endpoint_t, remote_pk) == 16,
               "gn_endpoint_t::remote_pk offset pinned at 16");
_Static_assert(offsetof(gn_endpoint_t, trust) == 48,
               "gn_endpoint_t::trust offset pinned at 48");
_Static_assert(offsetof(gn_endpoint_t, uri) == 52,
               "gn_endpoint_t::uri offset pinned at 52");
_Static_assert(offsetof(gn_endpoint_t, scheme) == 308,
               "gn_endpoint_t::scheme offset pinned at 308");
_Static_assert(offsetof(gn_endpoint_t, bytes_in) == 328,
               "gn_endpoint_t::bytes_in offset pinned at 328");
_Static_assert(offsetof(gn_endpoint_t, bytes_out) == 336,
               "gn_endpoint_t::bytes_out offset pinned at 336");
_Static_assert(offsetof(gn_endpoint_t, frames_in) == 344,
               "gn_endpoint_t::frames_in offset pinned at 344");
_Static_assert(offsetof(gn_endpoint_t, frames_out) == 352,
               "gn_endpoint_t::frames_out offset pinned at 352");
_Static_assert(offsetof(gn_endpoint_t, pending_queue_bytes) == 360,
               "gn_endpoint_t::pending_queue_bytes offset pinned at 360");
_Static_assert(offsetof(gn_endpoint_t, last_rtt_us) == 368,
               "gn_endpoint_t::last_rtt_us offset pinned at 368");
_Static_assert(offsetof(gn_endpoint_t, _reserved) == 376,
               "gn_endpoint_t::_reserved offset pinned at 376");
...
_Static_assert(sizeof(host_api_t) == 384,
               "host_api_t size pinned at 384");
...
_Static_assert(offsetof(host_api_t, disconnect) == 24,
               "host_api_t::disconnect offset pinned at 24");
_Static_assert(offsetof(host_api_t, register_vtable) == 32,
               "host_api_t::register_vtable offset pinned at 32");
_Static_assert(offsetof(host_api_t, unregister_vtable) == 40,
               "host_api_t::unregister_vtable offset pinned at 40");
_Static_assert(offsetof(host_api_t, find_conn_by_pk) == 48,
               "host_api_t::find_conn_by_pk offset pinned at 48");
_Static_assert(offsetof(host_api_t, get_endpoint) == 56,
               "host_api_t::get_endpoint offset pinned at 56");
_Static_assert(offsetof(host_api_t, query_extension_checked) == 64,
               "host_api_t::query_extension_checked offset pinned at 64");
_Static_assert(offsetof(host_api_t, register_extension) == 72,
               "host_api_t::register_extension offset pinned at 72");
_Static_assert(offsetof(host_api_t, unregister_extension) == 80,
               "host_api_t::unregister_extension offset pinned at 80");
_Static_assert(offsetof(host_api_t, config_get) == 88,
               "host_api_t::config_get offset pinned at 88");
_Static_assert(offsetof(host_api_t, limits) == 96,
               "host_api_t::limits offset pinned at 96");
_Static_assert(offsetof(host_api_t, log) == 104,
               "host_api_t::log offset pinned at 104");
_Static_assert(offsetof(host_api_t, notify_connect) == 192,
               "host_api_t::notify_connect offset pinned at 192");
_Static_assert(offsetof(host_api_t, notify_inbound_bytes) == 200,
               "host_api_t::notify_inbound_bytes offset pinned at 200");
_Static_assert(offsetof(host_api_t, notify_disconnect) == 208,
               "host_api_t::notify_disconnect offset pinned at 208");
_Static_assert(offsetof(host_api_t, register_security) == 216,
               "host_api_t::register_security offset pinned at 216");
_Static_assert(offsetof(host_api_t, unregister_security) == 224,
               "host_api_t::unregister_security offset pinned at 224");
_Static_assert(offsetof(host_api_t, inject) == 232,
               "host_api_t::inject offset pinned at 232");
_Static_assert(offsetof(host_api_t, kick_handshake) == 240,
               "host_api_t::kick_handshake offset pinned at 240");
_Static_assert(offsetof(host_api_t, set_timer) == 248,
               "host_api_t::set_timer offset pinned at 248");
_Static_assert(offsetof(host_api_t, cancel_timer) == 256,
               "host_api_t::cancel_timer offset pinned at 256");
_Static_assert(offsetof(host_api_t, subscribe) == 264,
               "host_api_t::subscribe offset pinned at 264");
_Static_assert(offsetof(host_api_t, unsubscribe) == 272,
               "host_api_t::unsubscribe offset pinned at 272");
_Static_assert(offsetof(host_api_t, for_each_connection) == 280,
               "host_api_t::for_each_connection offset pinned at 280");
_Static_assert(offsetof(host_api_t, notify_backpressure) == 288,
               "host_api_t::notify_backpressure offset pinned at 288");
_Static_assert(offsetof(host_api_t, emit_counter) == 296,
               "host_api_t::emit_counter offset pinned at 296");
_Static_assert(offsetof(host_api_t, iterate_counters) == 304,
               "host_api_t::iterate_counters offset pinned at 304");
_Static_assert(offsetof(host_api_t, is_shutdown_requested) == 312,
               "host_api_t::is_shutdown_requested offset pinned at 312");
_Static_assert(offsetof(host_api_t, _reserved) == 320,
               "host_api_t::_reserved offset pinned at 320");
...
_Static_assert(sizeof(gn_handshake_keys_t) == 184,
               "gn_handshake_keys_t size pinned at 184");
_Static_assert(offsetof(gn_handshake_keys_t, api_size) == 0,
               "gn_handshake_keys_t::api_size offset pinned at 0");
_Static_assert(offsetof(gn_handshake_keys_t, send_cipher_key) == 4,
               "gn_handshake_keys_t::send_cipher_key offset pinned at 4");
_Static_assert(offsetof(gn_handshake_keys_t, recv_cipher_key) == 36,
               "gn_handshake_keys_t::recv_cipher_key offset pinned at 36");
_Static_assert(offsetof(gn_handshake_keys_t, initial_send_nonce) == 72,
               "gn_handshake_keys_t::initial_send_nonce offset pinned at 72");
_Static_assert(offsetof(gn_handshake_keys_t, initial_recv_nonce) == 80,
               "gn_handshake_keys_t::initial_recv_nonce offset pinned at 80");
_Static_assert(offsetof(gn_handshake_keys_t, handshake_hash) == 88,
               "gn_handshake_keys_t::handshake_hash offset pinned at 88");
_Static_assert(offsetof(gn_handshake_keys_t, peer_static_pk) == 120,
               "gn_handshake_keys_t::peer_static_pk offset pinned at 120");
